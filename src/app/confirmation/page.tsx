        ...
        <div className="p-6">
            ...
            <div className="mt-6 flex justify-between">
                ...
                <div className="mb-4 flex gap-4">
                    <button
                        className={`flex-1 p-2 rounded ${matchMode === "partial" ? "bg-[#1E88E5] text-white" : "bg-gray-200 text-black dark:text-white"}`}
                        onClick={() => setMatchMode("partial")}
                    >
                        Match any ingredient
                    </button>
                    <button
                        className={`flex-1 p-2 rounded ${matchMode === "strict" ? "bg-[#1E88E5] text-white" : "bg-gray-200 text-black dark:text-white"}`}
