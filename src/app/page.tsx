...
export default function Home() {
    ...
    return (
        <main className="flex flex-col items-center justify-start w-full h-screen px-4 py-6 overflow-y-auto">
            ...
            <div className="bg-[#FDBA74] text-center text-gray-900 dark:text-white font-bold text-lg px-6 py-3 rounded-full shadow mb-6">
                What would you like to do?
            </div>

            <button
                className="flex items-center justify-between gap-2 w-full max-w-xs px-4 py-4 rounded-2xl bg-[#1E88E5] text-gray-900 dark:text-white text-lg font-bold mb-4 transition-all hover:bg-[#1565C0]"
            ...
            <button
                className="flex items-center justify-between gap-2 w-full max-w-xs px-4 py-4 rounded-2xl bg-[#1E88E5] text-gray-900 dark:text-white text-lg font-bold mb-6 transition-all hover:bg-[#1565C0]"
