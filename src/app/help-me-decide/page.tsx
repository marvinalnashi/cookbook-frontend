    ...
    if (!selectedOccasion) {
        return (
            <main className="p-6 flex flex-col items-center text-center">
                ...
                <div className="text-white text-lg font-bold mb-4 rounded-full bg-[#FDBA74] text-center px-6 py-3">
                    What is the occasion?
                </div>

                <button
                    className="flex items-center justify-between gap-2 w-full max-w-xs px-4 py-4 rounded-2xl bg-[#FCA5A5] text-gray-900 dark:text-white text-lg font-bold mb-4 transition-all hover:bg-[#EF4444]"
                    onClick={() => {
                ...
                <button
                    className="flex items-center justify-between gap-2 w-full max-w-xs px-4 py-4 rounded-2xl bg-[#FCA5A5] text-gray-900 dark:text-white text-lg font-bold mb-6 transition-all hover:bg-[#EF4444]"
                        ...
                        <button
                            ...
                            className={`w-full max-w-xs py-4 mb-4 rounded-2xl text-lg font-bold transition-all ${
                                isSelected
                                    ...
                                    : mode === "include"
                                        ? "bg-[#B9FBC0] text-gray-900 dark:text-white hover:bg-green-400"
                                        : "bg-[#FCA5A5] text-gray-900 dark:text-white hover:bg-red-400"
                            }`}
                        >
                            {ing}
                        </button>
